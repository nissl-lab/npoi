 ...
 * @author Yegor Kozlov
 */
public class TitleMaster : MasterSheet {
     ...
     *
     */
    public TitleMaster(NPOI.HSLF.record.Slide record, int sheetNo) {
        base(record, sheetNo);
    ...
    public MasterSheet GetMasterSheet(){
        ...
        SlideAtom sa = ((NPOI.HSLF.record.Slide)getSheetContainer()).GetSlideAtom();
