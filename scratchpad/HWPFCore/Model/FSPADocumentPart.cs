...
namespace NPOI.HWPF.Model
{
    ...
    {
        public static FSPADocumentPart HEADER = new FSPADocumentPart(FIBFieldHandler.PLCSPAHDR);

        public static FSPADocumentPart MAIN = new FSPADocumentPart(FIBFieldHandler.PLCSPAMOM);
