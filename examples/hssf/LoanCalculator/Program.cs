 ...
 */
        private static Dictionary<String, ICellStyle> CreateStyles(IWorkbook wb)
        {
            ...
            style.BorderBottom = CellBorderType.DOTTED;
