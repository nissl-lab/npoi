...
namespace TestCases.XWPF.Extractor
{
    ...
    public class TestXWPFWordExtractor
    {
        ...
        public void TestGetComplexText()
        {
            ...
            ClassicAssert.IsTrue(text.Contains(
        ...
        public void TestFootnotes()
        {
            ...
            XWPFWordExtractor extractor = new XWPFWordExtractor(doc);
            String text = extractor.Text;
            ClassicAssert.IsTrue(extractor.Text.Contains("snoska"));
            ClassicAssert.IsTrue(text.Contains("Eto ochen prostoy[footnoteRef:1] text so snoskoy"));
        }
        ...
        public void TestEndnotes()
        {
            ...
            XWPFWordExtractor extractor = new XWPFWordExtractor(doc);
            string text = extractor.Text;
            ClassicAssert.IsTrue(text.Contains("XXX"));
            ClassicAssert.IsTrue(text.Contains("tilaka [endnoteRef:2]or 'tika'"));
        }
        ...
        public void TestInsertedDeletedText()
        {
            ...
            ClassicAssert.IsTrue(extractor.Text.Contains("pendant worn"));
            ClassicAssert.IsTrue(extractor.Text.Contains("extremely well"));
        }
        ...
        public void TestParagraphHeader()
        {
            ...
            ClassicAssert.IsTrue(extractor.Text.Contains("Section 1"));
            ClassicAssert.IsTrue(extractor.Text.Contains("Section 2"));
            ClassicAssert.IsTrue(extractor.Text.Contains("Section 3"));
        }
        ...
        public void TestDOCMFiles()
        {
            ...
            ClassicAssert.IsTrue(extractor.Text.Contains("2004"));
            ClassicAssert.IsTrue(extractor.Text.Contains("2008"));
            ClassicAssert.IsTrue(extractor.Text.Contains("(120 "));
        }
        ...
        public void TestDocTabs()
        {
            ...
            // Check bits
            ClassicAssert.IsTrue(extractor.Text.Contains("a"));
            ClassicAssert.IsTrue(extractor.Text.Contains("\t"));
            ClassicAssert.IsTrue(extractor.Text.Contains("b"));
        ...
        public void TestFldSimpleContent()
        {
            ...
            String text = extractor.Text;
            ClassicAssert.IsTrue(text.Length > 0);
            ClassicAssert.IsTrue(text.Contains("FldSimple.docx"));
        }
