...
namespace TestCases.XSSF.EventUserModel
{
    ...
    public class TestXSSFBReader
    {
        ...
        public void TestBasic()
        {
            ...
            ClassicAssert.AreEqual(1, sheetTexts.Count);
        ...
        public void TestAbsPath()
        {
            ...
            ClassicAssert.AreEqual("C:\\Users\\tallison\\Desktop\\working\\xlsb\\", r.GetAbsPathMetadata());
        }
        ...
        private List<String> GetSheets(String testFileName)
        {
            ...
            ClassicAssert.IsNotNull(r.GetXSSFBStylesTable());
        ...
        public void TestDate()
        {
            ...
            ClassicAssert.AreEqual(1, sheets.Count);
