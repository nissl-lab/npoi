...
namespace TestCases.XSSF.UserModel
{
    ...
    public class TestXSSFWorkbook : BaseTestXWorkbook
    {
        ...
        public void Bug49702()
        {
            ...
            Assert.IsNull(wb1.GetCellStyleAt((short)1), "Shouldn't be able to get style at 1 that doesn't exist");
            ...
            Assert.IsNull(wb2.GetCellStyleAt((short)3), "Shouldn't be able to Get style at 3 that doesn't exist");
