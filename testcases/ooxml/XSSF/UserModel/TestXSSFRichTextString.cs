...
using org.Openxmlformats.schemas.spreadsheetml.x2006.main.CT_RPrElt;
using org.Openxmlformats.schemas.spreadsheetml.x2006.main.CTRst;
using org.Openxmlformats.schemas.spreadsheetml.x2006.main.STXstring;
...
public class TestXSSFRichTextString  {
    ...
    public void TestLineBreaks_bug48877() {
        ...
        t1 = str.GetCTRst().r.Get(0).xgetT();
        t2 = str.GetCTRst().r.Get(1).xgetT();
