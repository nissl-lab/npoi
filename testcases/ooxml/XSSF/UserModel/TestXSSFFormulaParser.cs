...
namespace TestCases.XSSF.UserModel
{
    ...
    public class TestXSSFFormulaParser
    {
        ...
        public void BasicParse()
        {
            ...
            ClassicAssert.IsTrue(ptgs[0] is RefPtg, "Had " + Arrays.ToString(ptgs));
            ...
            ClassicAssert.AreEqual(typeof(RefPtg), ptgs[1].GetType());
            ClassicAssert.AreEqual(typeof(FuncVarPtg), ptgs[2].GetType());
            ClassicAssert.AreEqual("ISEVEN", ptgs[0].ToFormulaString());
            ClassicAssert.AreEqual("A1", ptgs[1].ToFormulaString());
            ClassicAssert.AreEqual("#external#", ptgs[2].ToFormulaString());
            ...
            ClassicAssert.AreEqual("A1:B3", ptgs[0].ToFormulaString());
            ClassicAssert.AreEqual("SUM", ptgs[1].ToFormulaString());
            ...
            ClassicAssert.AreEqual(typeof(AttrPtg), ptgs[1].GetType());
            ClassicAssert.AreEqual("Sheet1!A1", ptgs[0].ToFormulaString());
            ClassicAssert.AreEqual("SUM", ptgs[1].ToFormulaString());

            // Formula referencing an area in a different sheet
            ptgs = Parse(fpb, "SUM(Sheet1!A1:B3)");
            ClassicAssert.AreEqual(2, ptgs.Length);
            ClassicAssert.AreEqual(typeof(Area3DPxg), ptgs[0].GetType());
            ClassicAssert.AreEqual(typeof(AttrPtg), ptgs[1].GetType());
            ClassicAssert.AreEqual("Sheet1!A1:B3", ptgs[0].ToFormulaString());
            ClassicAssert.AreEqual("SUM", ptgs[1].ToFormulaString());
        ...
        public void TestBuiltInFormulas()
        {
            ...
            ClassicAssert.AreEqual(2, ptgs.Length);
            ClassicAssert.IsTrue(ptgs[0] is IntPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is FuncPtg, "Had " + Arrays.ToString(ptgs));
        ...
        public void MultiSheetReferencesHSSFandXSSF()
        {
            ...
            foreach (IWorkbook wb in wbs)
            {
                ...
                ClassicAssert.IsNotNull(countAF);
                ClassicAssert.AreEqual("COUNTA(Sheet1:Sheet3!C1)", countAF.CellFormula);
                ...
                ClassicAssert.AreEqual("Sheet1:Sheet3!A1", ToFormulaString(ptgs[0], fpb));
                ClassicAssert.AreEqual(typeof(AttrPtg), ptgs[1].GetType());
                ClassicAssert.AreEqual("SUM", ToFormulaString(ptgs[1], fpb));
                ...
                ClassicAssert.AreEqual("Sheet1:Sheet3!$A$1", ToFormulaString(ptgs[0], fpb));
                ClassicAssert.AreEqual(typeof(FuncVarPtg), ptgs[1].GetType());
                ClassicAssert.AreEqual("MIN", ToFormulaString(ptgs[1], fpb));
                ...
                ClassicAssert.AreEqual(ToFormulaString(ptgs[0], fpb), "Sheet1:Sheet3!A1:B2");
                ClassicAssert.AreEqual(typeof(AttrPtg), ptgs[1].GetType());
                ClassicAssert.AreEqual("SUM", ToFormulaString(ptgs[1], fpb));
                ...
                ClassicAssert.AreEqual(ToFormulaString(ptgs[0], fpb), "Sheet1:Sheet3!$A$1:$B$2");
                ClassicAssert.AreEqual(typeof(FuncVarPtg), ptgs[1].GetType());
                ClassicAssert.AreEqual("MIN", ToFormulaString(ptgs[1], fpb));
                ...
                ClassicAssert.AreEqual("SUM(Sheet2:Sheet3!A1)", newF.CellFormula);
                ...
                ClassicAssert.AreEqual("MIN(Sheet1:Sheet2!A1:B2)", newF.CellFormula);
        ...
        public void Test58648Single()
        {
            ...
            Ptg[] ptgs;
            ptgs = Parse(fpb, "(ABC10 )");
            ClassicAssert.AreEqual(2, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is RefPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is ParenthesisPtg, "Had " + Arrays.ToString(ptgs));
        ...
        public void Test58648Basic()
        {
            ...
            ptgs = Parse(fpb, "(ABC10)");
            ClassicAssert.AreEqual(2, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is RefPtg);
            ClassicAssert.IsTrue(ptgs[1] is ParenthesisPtg);
            ptgs = Parse(fpb, "( ABC10)");
            ClassicAssert.AreEqual(2, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is RefPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is ParenthesisPtg, "Had " + Arrays.ToString(ptgs));
            ...
            ClassicAssert.IsTrue(ptgs[1] is ParenthesisPtg, "Had " + Arrays.ToString(ptgs));
            ptgs = Parse(fpb, "((ABC10))");
            ClassicAssert.AreEqual(3, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is RefPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is ParenthesisPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[2] is ParenthesisPtg, "Had " + Arrays.ToString(ptgs));
            ptgs = Parse(fpb, "((ABC10) )");
            ClassicAssert.AreEqual(3, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is RefPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is ParenthesisPtg, "Had " + Arrays.ToString(ptgs));
        ...
        public void Test58648FormulaParsing()
        {
            ...
            ClassicAssert.AreEqual(5d, cell1.NumericCellValue, 0d);
        ...
        public void TestWhitespaceInFormula()
        {
            ...
            ClassicAssert.AreEqual(3, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is AreaPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is AreaPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[2] is FuncPtg, "Had " + Arrays.ToString(ptgs));
            ...
            ClassicAssert.AreEqual(12, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is StringPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is AreaPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[2] is IntPtg, "Had " + Arrays.ToString(ptgs));
            ptgs = Parse(fpb, "A1:B1 B1:B2");
            ClassicAssert.AreEqual(4, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is MemAreaPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is AreaPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[2] is AreaPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[3] is IntersectionPtg, "Had " + Arrays.ToString(ptgs));
            ptgs = Parse(fpb, "A1:B1    B1:B2");
            ClassicAssert.AreEqual(4, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is MemAreaPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is AreaPtg, "Had " + Arrays.ToString(ptgs));
        ...
        public void TestWhitespaceInComplexFormula()
        {
            ...
            ClassicAssert.AreEqual(40, ptgs.Length, "Had: " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is MemFuncPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is RefPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[2] is AreaPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[3] is NameXPxg, "Had " + Arrays.ToString(ptgs));
            ptgs = Parse(fpb, "SUM ( A1 : INDEX( 1 : 1048576 , MAX( IFERROR ( MATCH ( 99 ^ 99 , B : B , 1 ) , 0 ) , IFERROR ( MATCH ( \"zzzz\" , B:B , 1 ) , 0 ) ) , MAX ( IFERROR ( MATCH ( 99 ^ 99 , 1 : 1 , 1 ) , 0 ) , IFERROR ( MATCH ( \"zzzz\" , 1 : 1 , 1 )   , 0 )   )   )   )");
            ClassicAssert.AreEqual(40, ptgs.Length, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[0] is MemFuncPtg, "Had " + Arrays.ToString(ptgs));
            ClassicAssert.IsTrue(ptgs[1] is RefPtg, "Had " + Arrays.ToString(ptgs));
        ...
        public void ParseStructuredReferences()
        {
            ...
            */
            ...
            ClassicAssert.IsTrue(ptgs[0] is Area3DPxg);
            Area3DPxg ptg0 = (Area3DPxg)ptgs[0];
            ClassicAssert.AreEqual("Table", ptg0.SheetName);
            ClassicAssert.AreEqual("A2:A7", ptg0.Format2DRefAsString());
            // Note: structured references are evaluated and resolved to regular 3D area references.
            ClassicAssert.AreEqual("Table!A2:A7", ptg0.ToFormulaString());
            // AttrPtg [sum ]
            ClassicAssert.IsTrue(ptgs[1] is AttrPtg);
            AttrPtg ptg1 = (AttrPtg)ptgs[1];
            ClassicAssert.IsTrue(ptg1.IsSum);

            ////// Case 1: Evaluate "Table1[col]" ////////
            ptgs = Parse(fpb, tbl + "[Name]");
            ClassicAssert.AreEqual(1, ptgs.Length);
            ClassicAssert.AreEqual("Table!B2:B7", ptgs[0].ToFormulaString(), "Table1[col]");
            ...
            ClassicAssert.AreEqual(1, ptgs.Length);
            ClassicAssert.AreEqual(ErrPtg.REF_INVALID, ptgs[0], "Table1[#Totals]" + noTotalsRowReason);

            ////// Case 4: Evaluate "Table1[#All]" ////////
            ptgs = Parse(fpb, tbl + "[#All]");
            ClassicAssert.AreEqual(1, ptgs.Length);
            ClassicAssert.AreEqual("Table!A1:C7", ptgs[0].ToFormulaString(), "Table1[#All]");

            ////// Case 5: Evaluate "Table1[#Data]" (excludes Header and Data rows) ////////
            ptgs = Parse(fpb, tbl + "[#Data]");
            ClassicAssert.AreEqual(1, ptgs.Length);
            ClassicAssert.AreEqual("Table!A2:C7", ptgs[0].ToFormulaString(), "Table1[#Data]");

            ////// Case 6: Evaluate "Table1[#Headers]" ////////
            ptgs = Parse(fpb, tbl + "[#Headers]");
            ClassicAssert.AreEqual(1, ptgs.Length);
            ClassicAssert.AreEqual("Table!A1:C1", ptgs[0].ToFormulaString(), "Table1[#Headers]");
            ...
            ClassicAssert.AreEqual(1, ptgs.Length);
            ClassicAssert.AreEqual("Table!A3:C3", ptgs[0].ToFormulaString(), "Table1[#This Row]");
            ...
            ClassicAssert.AreEqual(1, ptgs.Length);
            ClassicAssert.AreEqual(ErrPtg.VALUE_INVALID, ptgs[0], "Table1[@]");
            ...
            ClassicAssert.AreEqual("Table!C1:C1", ptgs[0].ToFormulaString(), "Table1[[#Headers],[col]]");
            ...
            ClassicAssert.AreEqual(1, ptgs.Length);
            ClassicAssert.AreEqual("Table!B2:C7", ptgs[0].ToFormulaString(), "Table1[[col]:[col2]]");
            wb.Close();
        }
