...
namespace TestCases.XSSF.Extractor
{
    ...
    public class TestXSSFEventBasedExcelExtractor
    {
        ...
        public void TestUnstyledNumbersComparedToNonEventBasedExtractor()
        {
            ...
            try
            {
                Assert.AreEqual(expectedOutput, extractor.Text.Replace(",", "."));
            }
            finally
            {
                extractor.Close();
            ...
            try
            {
                Assert.AreEqual(expectedOutput, fixture.Text.Replace(",", "."));
            }
            finally
            {
                fixture.Close();
        ...
        public void TestHeadersAndFootersComparedToNonEventBasedExtractor()
        {
            ...
            try
            {
                Assert.AreEqual(expectedOutputWithHeadersAndFooters, extractor.Text);
                extractor.IncludeHeadersFooters = (false);
                Assert.AreEqual(expectedOutputWithoutHeadersAndFooters, extractor.Text);
            }
            finally
            {
                extractor.Close();
            ...
            try
            {
                Assert.AreEqual(expectedOutputWithHeadersAndFooters, fixture.Text);
                fixture.IncludeHeadersFooters = (false);
                Assert.AreEqual(expectedOutputWithoutHeadersAndFooters, fixture.Text);
            }
            finally
            {
                fixture.Close();
        ...
        public void TestCommentsComparedToNonEventBasedExtractor()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(expectedOutputWithoutComments, extractor.Text);
                extractor.IncludeCellComments = (true);
                Assert.AreEqual(nonEventBasedExtractorOutputWithComments, extractor.Text);
            }
            finally
            {
                extractor.Close();
            ...
            try
            {
                Assert.AreEqual(expectedOutputWithoutComments, fixture.Text);
                fixture.IncludeCellComments = (true);
                Assert.AreEqual(eventBasedExtractorOutputWithComments, fixture.Text);
            }
            finally
            {
                fixture.Close();
        ...
        public void Test51519()
        {
            ...
            text = ex.Text;
            Assert.IsFalse(text.Contains("\u65E5\u672C\u30AA\u30E9\u30AF\u30EB \u30CB\u30DB\u30F3"),
