...
namespace TestCases.Util
{
    ...
    public class TestULongField
    {
        ...
        public void TestConstructors()
        {
            ...
            ClassicAssert.AreEqual((ulong)0L, field.Value);
            try
            {
                new ULongField(-1, 1L);
                Assert.Fail("Should have caught IndexOutOfRangeException");
            ...
            ClassicAssert.AreEqual((ulong)0x123456789ABCDEF0L, field.Value);
            ...
            for (int j = 0; j < _test_array.Length; j++)
            {
                ...
                ClassicAssert.AreEqual(_test_array[j], new ULongField(0, array).Value);
            }
        }
