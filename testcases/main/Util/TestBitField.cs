...
namespace TestCases.Util
{
    ...
    public class TestBitField
    {
        ...
        {
            ClassicAssert.AreEqual(bf_multi.GetValue(-1), 127);
            ClassicAssert.AreEqual(bf_multi.GetValue(0), 0);
            ClassicAssert.AreEqual(bf_single.GetValue(-1), 1);
            ClassicAssert.AreEqual(bf_single.GetValue(0), 0);
        }
        /// <summary>
        ...
        {
            ClassicAssert.AreEqual(bf_multi.GetRawValue(-1), 0x3F80);
            ClassicAssert.AreEqual(bf_multi.GetRawValue(0), 0);
            ClassicAssert.AreEqual(bf_single.GetRawValue(-1), 0x4000);
            ClassicAssert.AreEqual(bf_single.GetRawValue(0), 0);
        }
        /// <summary>
        ...
        public void TestIsSet()
        {
            ...
            ClassicAssert.IsTrue(!bf_single.IsSet(0));
            ClassicAssert.IsTrue(bf_single.IsSet(0x4000));
        }
        /// <summary>
        ...
        public void TestIsAllSet()
        {
            ...
            ClassicAssert.IsTrue(bf_multi.IsAllSet(0x3F80));
            ClassicAssert.IsTrue(!bf_single.IsAllSet(0));
            ClassicAssert.IsTrue(bf_single.IsAllSet(0x4000));
        }
        /// <summary>
        /// Tests the set value.
        /// </summary>
        ...
        public void TestSetValue()
        {
            ...
            // verify that excess bits are stripped off
            ClassicAssert.AreEqual(bf_single.SetValue(0x4000, 2), 0);
        }
        /// <summary>
        ...
        public void TestSet()
        {
            ClassicAssert.AreEqual(bf_multi.Set(0), 0x3F80);
            ClassicAssert.AreEqual(bf_single.Set(0), 0x4000);
        }
        /// <summary>
        /// Tests the set short.
        /// </summary>
        ...
        {
            ClassicAssert.AreEqual(bf_multi.Set(0), bf_multi.SetBoolean(0, true));
            ClassicAssert.AreEqual(bf_single.Set(0), bf_single.SetBoolean(0, true));
            ClassicAssert.AreEqual(bf_multi.Clear(-1), bf_multi.SetBoolean(-1, false));
            ClassicAssert.AreEqual(bf_single.Clear(-1), bf_single.SetBoolean(-1, false));
        }
        /// <summary>
        ...
        public void TestSetLargeValues()
        {
            ...
            a = bf1.SetValue(a, 9);
            a = bf2.SetValue(a, 9);
            ClassicAssert.AreEqual(9, bf1.GetValue(a));
            ClassicAssert.AreEqual(9, bf2.GetValue(a));
        }
    }
}
