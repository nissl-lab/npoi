...
namespace TestCases.SS.Formula.Functions
{
    ...
    public class TestFinanceLib : AbstractNumericTestCase
    {
        ...
        public void TestFv()
        {
            ...
            ClassicAssert.AreEqual(x, f, 0.01, "fv ");
        ...
        public void TestNpv()
        {
            ...
            x = 162.5;
            ClassicAssert.AreEqual(x, npv, 0.000001, "npv ");
            ...
            npv = FinanceLib.npv(r, v);
            x = 11342283.4233124;
            ClassicAssert.AreEqual(x, npv, 0.0000001, "npv ");
        }
        [Test]
        public void TestPmt()
        {
            ...
            x = -3;
            ClassicAssert.AreEqual(x, y, "pmt ");
        ...
        public void TestPv()
        {
            ...
            x = -13;
            ClassicAssert.AreEqual(x, f, "pv ");

            r = 1; n = 10; y = 100; f = 10000; t = false;
            p = FinanceLib.pv(r, n, y, f, t);
            x = -109.66796875;
            ClassicAssert.AreEqual(x, p, "pv ");
            ...
            p = FinanceLib.pv(r, n, y, f, t);
            x = -4406.78544294496;
            ClassicAssert.AreEqual(x, p, 0.0000001, "pv ");
        ...
        public void TestNper()
        {
            ...
            ClassicAssert.AreEqual(x, n, 0.0000000001, "nper ");

            // cross check with pv
            r = 1; y = 100; p = -109.66796875; f = 10000; t = false;
            n = FinanceLib.nper(r, y, p, f, t);
            x = 10;
            ClassicAssert.AreEqual(x, n, 0.01, "nper ");

            r = 1; y = 100; p = -209.5703125; f = 10000; t = true;
            n = FinanceLib.nper(r, y, p, f, t);
            x = 10;
            ClassicAssert.AreEqual(x, n, 0.1, "nper ");

            // cross check with fv
            r = 2; y = 120; f = -6409178400d; p = 12000; t = false;
            n = FinanceLib.nper(r, y, p, f, t);
            x = 12;
            ClassicAssert.AreEqual(x, n, "nper ");
