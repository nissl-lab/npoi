...
using NPOI.SS.Formula.PTG.Ref3DPtg;
using NPOI.SS.Formula.PTG.RefPtg;
using NPOI.SS.Formula.Eval.AreaEval;
using NPOI.SS.Formula.Eval.AreaEvalBase;
using NPOI.SS.Formula.Eval.NumberEval;
using NPOI.SS.Formula.Eval.RefEval;
using NPOI.SS.Formula.Eval.RefEvalBase;
...
public class EvalFactory {
	...
	private static class MockAreaEval : AreaEvalBase {
		...
		public AreaEval offset(int relFirstRowIx, int relLastRowIx, int relFirstColIx, int relLastColIx) {
			...
			return new MockAreaEval(getFirstRow() + relFirstRowIx, FirstColumn + relFirstColIx,
		...
		public TwoDEval GetColumn(int columnIndex) {
			...
			return new MockAreaEval(getFirstRow(), columnIndex, LastRow, columnIndex, values);
		}
	}
