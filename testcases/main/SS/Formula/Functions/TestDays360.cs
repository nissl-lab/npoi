...
public class TestDays360  {
	 ...
	 * @param diffs
	 */
	private static void ConfirmMonthBoundary(bool method, int monthNo, int...diffs) {
	...
	private static void Confirm(int expResult, Date firstArg, Date secondArg, bool method) {
		...
		throw new AssertionFailedError("wrong return type (" + ve.GetType().GetName() + ")");
	}
