...
namespace TestCases.SS.Formula.Functions
{
    ...
    public class TestDollarDe
    {
        ...
        public void TestMicrosoftExample1()
        {
            ...
            SS.Util.Utils.AssertDouble(fe, cell, "DOLLARDE(1.02,16)", 1.125, tolerance);
            SS.Util.Utils.AssertDouble(fe, cell, "DOLLARDE(1.02,16.9)", 1.125, tolerance);
            SS.Util.Utils.AssertDouble(fe, cell, "DOLLARDE(1.32,16)", 3.0, tolerance);
            SS.Util.Utils.AssertDouble(fe, cell, "DOLLARDE(-1.02,16)", -1.125, tolerance);
            SS.Util.Utils.AssertDouble(fe, cell, "DOLLARDE(1.1,32)", 1.3125, tolerance);
            SS.Util.Utils.AssertDouble(fe, cell, "DOLLARDE(1.1,32.1)", 1.3125, tolerance);
            SS.Util.Utils.AssertDouble(fe, cell, "DOLLARDE(1.0,32)", 1.0, tolerance);
            SS.Util.Utils.AssertDouble(fe, cell, "DOLLARDE(1.000001,32)", 1.000003125, tolerance);
        }
        ...
        private static void confirmValue(String number1, String number2, double expected)
        {
            ...
            ClassicAssert.AreEqual(expected, ((NumberEval)result).NumberValue, 0.00000000000001);
        }
