...
namespace NPOI.POIFS.Crypt
{
    ...
    public class CryptoFunctions {
         ...
         * ... continued ...
         * 
         * The hash data that is used for an encryption key is then generated by using the following
         * method:
         * 
        ...
        public static int CreateXorVerifier2(String password) {
            ...
            if (!"".Equals(password)) {
                ...
                unchecked
                {
                    ...
                    verifier ^= (short)0xCE4B; // (0x8000 | ('N' << 8) | 'K')
                }
        ...
        public static byte[] CreateXorArray1(string password) {
            ...
            Array.Copy(PadArray, 0, obfuscationArray, passBytes.Length, PadArray.Length - passBytes.Length + 1);
