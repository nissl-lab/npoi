...
namespace NPOI.SS.Util
{
    ...
    /// <list type="bullet">
    /// <item><description>No more than 15 significant figures are output (java does 18).</description></item>
    /// <item><description>The sign char for the exponent is included even if positive</description></item>
    /// <item><description>Special values (<c>NaN</c> and <c>InfInity</c>) Get rendered like the ordinary
    /// number that the bit pattern represents.</description></item>
    /// <item><description>Denormalised values (between ±2<sup>-1074</sup> and ±2<sup>-1022</sup>
    ///  are displayed as "0"</sup></description></item>
    /// </list>
    ...
    /// <list type="bullet">
    /// <item><description>Conversion to string (as handled here)</description></item>
    /// <item><description>Rendering numerical quantities in the cell grid.</description></item>
    /// <item><description>Conversion from text</description></item>
    /// <item><description>General arithmetic</description></item>
    /// </list>
