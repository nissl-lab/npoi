...
namespace NPOI.SS.Formula.Functions
{
    ...
    public class Ddb : NumericFunction
    {
        protected override double Eval(ValueEval[] args, int srcCellRow, int srcCellCol)
        {
            ...
            double factor = FinancialHelper.GetDoubleArg(args, 4, srcCellRow, srcCellCol, 2.0);

            double result = EFF.Financial.Ddb(cost, salvage, life, period, factor);
            CheckValue(result);
            return result;
        }
    }
