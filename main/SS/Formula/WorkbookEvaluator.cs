...
namespace NPOI.SS.Formula
{
    ...
    /// cell values.  Be sure To call <see cref="ClearCache()" /> if any workbook cells are Changed between
    ...
    public class WorkbookEvaluator
    {
        ...
        /// Case-insensitive.
        /// </summary>
        /// <returns>-1 if sheet with specified name does not exist</returns>
        /* package */
        ...
        /// </summary>
        /// <param name="formula">to evaluate</param>
        /// <param name="ref">defines the optional sheet and row/column base for the formula, if it is relative</param>
        ...
        /// <summary>
        /// </summary>
        /// <returns>never <c>null</c>, never <see cref="BlankEval"/></returns>
        ...
        /// </summary>
        /// <param name="cell">may be <c>null</c></param>
        /// <returns><see cref="BlankEval"/> if cell is <c>null</c> or blank, never <c>null</c></returns>
        /* package */
        ...
        /// </summary>
        /// <returns>the number of tokens (starting from <c>startIndex+1</c>) that need to be skipped
        ...
        /// </summary>
        /// <returns>a <c>NumberEval</c>, <c>StringEval</c>, <c>BoolEval</c>,
        ...
        /// returned as-is.
        /// </summary>
        /// <returns>a <see cref="NumberEval"/>, <see cref="StringEval"/>, <see cref="BoolEval"/>, or
        /// <see cref="ErrorEval"/>. Never <c>null</c>. <see cref="BlankEval"/> is
        /// converted to <see cref="NumberEval.ZERO" />
        /// </returns>
        ...
        /// <list type="bullet">
        ///     <item><description>by default ignoreMissingWorkbooks=false and POI throws <see cref="WorkbookNotFoundException"/>
        ///     if an external reference cannot be resolved</description></item>
        ///     <item><description>if ignoreMissingWorkbooks=true then POI uses cached formula result
        ///     that already exists in the main workbook</description></item>
        /// </list>
        /// </para>
        /// </summary>
        /// <see href="https://issues.apache.org/bugzilla/show_bug.cgi?id=52575">Bug 52575 for details</see>
        ...
        /// </summary>
        /// <returns>names of functions supported by POI</returns>
        ...
        /// </summary>
        /// <returns>names of functions NOT supported by POI</returns>
        ...
        /// <param name="func"> the functoin to register</param>
        /// <exception cref="ArgumentException">if the function is unknown or already  registered.</exception>
        /// @since 3.8 beta6
