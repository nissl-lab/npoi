...
namespace NPOI.SS.UserModel
{
    ...
    public class DateUtil
    {
         ...
         */
        private static readonly Regex date_ptrn1 = new Regex("^\\[\\$\\-.*?\\]", RegexOptions.Compiled);
        private static readonly Regex date_ptrn2 = new Regex("^\\[[a-zA-Z]+\\]", RegexOptions.Compiled);
        private static readonly Regex date_ptrn3a = new Regex("[yYmMdDhHsS]", RegexOptions.Compiled);
        private static readonly Regex date_ptrn3b = new Regex("^[\\[\\]yYmMdDhHsS\\-T/,. :\"\\\\]+0*[ampAMP/]*$", RegexOptions.Compiled);
        //  elapsed time patterns: [h],[m] and [s]
        //private static readonly Regex date_ptrn4 = new Regex("^\\[([hH]+|[mM]+|[sS]+)\\]", RegexOptions.Compiled);
        private static readonly Regex date_ptrn4 = new Regex("^\\[([hH]+|[mM]+|[sS]+)\\]$", RegexOptions.Compiled);
