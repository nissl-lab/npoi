...
namespace NPOI.SS.UserModel
{
    ...
    /// cell values.  Be sure to call <see cref="ClearAllCachedResultValues()" /> if any workbook cells are Changed between
    ...
    public interface IFormulaEvaluator
    {
        ...
        ///  the result of the formula, use <see cref="EvaluateInCell(Cell)" />
        /// </summary>
        /// <param name="cell">The cell to Evaluate</param>
        /// <returns>The type of the formula result, i.e. -1 if the cell is not a formula,
        ...
        ///  value comPuted for you, use <see cref="EvaluateFormulaCell(Cell)" />
        /// </summary>
        /// <param name="cell">cell</param>
        ...
        /// </summary>
        /// <param name="otherWorkbooks">Map of workbook names (no square brackets) to an evaluator on that workbook</param>
        ...
        /// <list type="bullet">
        ///     <item><description>by default ignoreMissingWorkbooks=false and POI throws
        ///     <see cref="org.apache.poi.ss.formula.CollaboratingWorkbooksEnvironment.WorkbookNotFoundException" />
        ...
        /// </list>
        /// </summary>
        /// <param name="ignore">whether to ignore missing references to external workbooks</param>
        ...
        /// </summary>
        /// <param name="value">whether to perform detailed output</param>
