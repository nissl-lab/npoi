...
namespace NPOI.SS.UserModel
{
    ...
    public class BuiltinFormats
    {
        ...
        /// <summary>
        /// </summary>
        /// <return>array of built-in data formats</return>
        ...
        /// </summary>
        /// <param name="index">of a built in format</param>
        /// <return>string represented at index of format or <c>null</c> if there is not a built-in format at that index</return>
        ...
        /// </para>
        /// </summary>
        /// <param name="pFmt">string matching a built-in format</param>
        /// <return>index of format or -1 if undefined.</return>
