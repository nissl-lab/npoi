...
namespace NPOI.SS.UserModel
{
    ...
    ///  <see cref="NPOI.XSSF.UserModel.XSSFColor"/> or a
    ///  <see cref="NPOI.HSSF.Record.Common.ExtendedColor" />
    /// </summary>
    public abstract class ExtendedColor : IColor
    {
        ...
        /// <summary>
        /// Indexed Color value, if <see cref="isIndexed()" /> is true
        /// </summary>
        ...
        /// <summary>
        /// Index of Theme color, if <see cref="isThemed()" /> is true
        /// </summary>
