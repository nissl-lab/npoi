...
namespace NPOI.HSSF.UserModel
{
    ...
    public class HSSFCellStyle : ICellStyle
    {
        ...
        private static readonly ThreadLocal<short> lastDateFormat = new ThreadLocal<short>(() => short.MinValue);
        private static readonly ThreadLocal<List<FormatRecord>> lastFormats = new ThreadLocal<List<FormatRecord>>(() => null);
        private static readonly ThreadLocal<String> getDataFormatStringCache = new ThreadLocal<String>(() => null);
        /// <summary>
