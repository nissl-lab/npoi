...
namespace NPOI.HPSF
{
    ...
    //using org.apache.Commons.collections4.bidimap.TreeBidiMap;
    ...
    /// custom properties in a dictionary. It : the {@link Map} interface
    ...
    public class CustomProperties : Dictionary<long, CustomProperty>
    {
        ...
        /// <throws name="ClassCastException">ClassCastException</throws>
