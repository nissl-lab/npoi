...

{
    ...
    public class Property
    {
        ...
        /// <throws name="UnsupportedEncodingException">if the dictionary's codepage is not
        /// (yet) supported.
        /// </throws>
        ...
        /// 
        /// <exception name="WritingNotSupportedException">if HPSF does not yet support the
        ...
        /// <exception name="WritingNotSupportedException">if a variant type is to be
