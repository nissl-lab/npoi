...
{
    private CT_Line3DChart chart;

    public XDDFLine3DChartData(CT_Line3DChart chart, Dictionary<long, XDDFChartAxis> categories,
            ...
            IXDDFNumericalDataSource<V> values)
    {
        ...
        CT_LineSer ctSer = new CT_LineSer();
        chart.ser.Add(ctSer);
    ...
    public class Series : XDDFChartData<T, V>.Series
    {
        ...
        public void SetSmooth(bool? smooth)
        {
            ...
            else
            {
                ...
                {
                    series.smooth = new CT_Boolean { val = smooth.Value ? 1 : 0 };
                }
            }
        }
        ...
        public void SetMarkerSize(byte size)
        {
            ...
            {
                marker.size = new CT_MarkerSize { val = size };
            }
        }
        ...
        public void SetMarkerStyle(MarkerStyle style)
        {
            ...
            {
                marker.symbol = new CT_MarkerStyle { val = style.ToST_MarkerStyle() };
            }
        }
