...
namespace NPOI.XDDF.UserModel.Chart
{
    ...
    public class XDDFScatterChartData<T, V> : XDDFChartData<T, V>
    {
        ...
        public XDDFScatterChartData(CT_ScatterChart chart, Dictionary<long, XDDFChartAxis> categories,
        ...
        {
            CT_ScatterStyle scatterStyle = chart.scatterStyle;
            if(scatterStyle == null)
            {
                scatterStyle = chart.AddNewScatterStyle();
                scatterStyle.val = ScatterStyle.LineMarker.ToST_ScatterStyle();
            }
            return ScatterStyleExtensions.ValueOf(scatterStyle.val);
        }
        ...
        public void SetStyle(ScatterStyle style)
        {
            ...
            scatterStyle.val = style.ToST_ScatterStyle();
        }
                ...
                IXDDFNumericalDataSource<V> values)
        {
            ...
            CT_ScatterSer ctSer = this.chart.AddNewSer();
            ctSer.AddNewXVal();
            ctSer.AddNewYVal();
