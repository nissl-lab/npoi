...
namespace NPOI.XDDF.UserModel.Text
{
    ...
    public class XDDFBulletStyleAutoNumbered : IXDDFBulletStyle
    {
        ...
        public AutonumberScheme Type
        {
            get
            {
                return AutonumberSchemeExtensions.ValueOf(style.type);
            }
            set
            {
                style.type = value.ToST_TextAutonumberScheme();
            }
        }
